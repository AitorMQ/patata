<?php
    ...
    $cmdAlta="INSERT INTO vacunas (codigo,nombre,fehaAprobacion,suspendida,codEmpresa,numeroDeDosis,limiteMinimoDias,limiteMaximoDias,efectosSecundarios,tipoVacuna) VALUES ('".$codigo."','".$nombre."','".$fehaAprobacion."','".$suspendida."','".$codEmpresa."','".$numeroDeDosis."','".$limiteMinimoDias."','".$limiteMaximoDias."','".$efectosSecundarios."','".$tipoVacuna."')";
	//echo $cmdAlta;
	
	mysqli_query($conexion, $cmdAlta);
